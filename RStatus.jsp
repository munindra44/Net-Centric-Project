...
<body>
<form name="Login" action="RStatus1.jsp">
	<div style="width:auto; height:50px; background:green;">
	<br/>
	<table align="left">
	<tr>
	...
	<img src="img/Gallery/3.jpg" width="100%" height="500">
	</div>
	<div style="width:auto; height:120px; background:gold;">
